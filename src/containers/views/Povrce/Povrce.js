...
const Povrce = (props) => {
  ...
  const [povrce,] = useState([
    ...
    { img: Karfiol , naziv: "Karfiol"},
    { img: Krastavac , naziv: "Krastavac"},
    { img: Krompir , naziv: "Krompir"},
    { img: Luksutkasrebrenjaka, naziv: "Luk sutka srebrenjaka" },
    { img: Mladcrniluk, naziv: "Mlad crni luk" },
    { img: Mladkrompir, naziv: "Mlad krompir" },
    { img: Paprikacrvena, naziv: "Paprika crvena" },
